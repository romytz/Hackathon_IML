...
import preprocessing_passenger_boardings as preprocessing
...
def run(training_set, test_set, out):
    ...
    preprocessed_train_df = preprocessing.preprocess_data(train_df, is_train=True)
    ...
    test_df[['trip_id_unique_station', 'passengers_up_predictions']].to_csv(out, index=False)
